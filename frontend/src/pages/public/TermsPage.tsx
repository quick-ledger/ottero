...
### Definitions:
1. **Charges**: means the applicable fees payable by you to Ottero in exchange for our services.
2. **Services**: means the cloud-based invoicing, quote generation, code generation, and business management software provided by Ottero.
3. **Customer Data**: means data relating to your customers (e.g., names, addresses, contact details) that you input into the Service. Ottero does **not** process or store payment methods (credit cards, bank details) of your customers.

### Use of Service:
- Ottero provides tools to manage company information, customer details, and generate business documents like quotes, invoices, and codes.
- You retain ownership of all data you input into the Service.
- You agree not to use the Service to store sensitive financial data of your customers (such as credit card numbers) within fields not explicitly designated for such information.
- **Responsibility for Generated Content**: You are solely responsible for verifying the accuracy, legality, and compliance of any invoices, quotes, codes, or other documents generated using the Service before issuing them to your customers. Ottero is not responsible for any errors, omissions, or tax implications resulting from your use of the Service.
...
- **4.2** You authorize Ottero to automatically charge the amount you owe to the designated payment method (e.g., credit card) you provided.
...
### Governing Law:
- **11.1** This Agreement shall be governed by and construed in accordance with the laws of Australia, without giving effect to any principles of conflicts of law.
- **11.2** Any dispute arising from this Agreement shall be subject to the exclusive jurisdiction of the courts located in Australia.
`;

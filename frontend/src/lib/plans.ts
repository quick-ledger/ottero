...
export const FEATURE_LABELS: Record<Feature, string> = {
    ...
    CUSTOM_TEMPLATES: 'Custom Invoice & Quote Templates',
...
export const PLANS_CONFIG: PlanConfig[] = [
    {
        ...
        features: ['Up to 5 Quotes and Invoices/month', 'Payment Reminders', 'Custom Invoice & Quote Templates', 'Customer & Employee CRM'],
        variant: 'outline',
    },
    {
        id: 'price_basic',
